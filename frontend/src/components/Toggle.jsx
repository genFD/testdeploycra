      ...
      <div className="mx-auto flex flex-col items-center">
        <div className="cursor-pointer rounded-full relative shadow-sm">
          <input
            ...
            name="toggle"
            id="toggle"
            className="focus:outline-none checkbox w-4 h-4 rounded-full bg-5964E0 absolute m-1 shadow-sm appearance-none cursor-pointer"
          />
          <span className="sr-only">Toggle dark mode</span>
          <label
            htmlFor="toggle"
            className="toggle-label dark:bg-121721 block w-12 h-6 overflow-hidden rounded-full bg-gray-300 cursor-pointer"
          />
        </div>
        <style>
          {`.checkbox:checked { 
